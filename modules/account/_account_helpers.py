...
class AccountAuditHelpers:
    ...
    @staticmethod
    def account_create_audit_message(action: str, account_id: int, old_values: Optional[Dict] = None, 
                                   new_values: Optional[Dict] = None) -> Dict[str, Any]:
        """
        감사 로그 메시지 생성
    ...
    def _account_sanitize_values(values: Optional[Dict]) -> Optional[Dict]:
        ...
        sensitive_fields = [
            'oauth_client_secret', 'access_token', 'refresh_token', 
