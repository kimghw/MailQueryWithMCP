"""HTTP Streaming-based MCP Server for Query Assistant"""
...
class HTTPStreamingQueryAssistantServer:
    """HTTP Streaming-based MCP Server for Query Assistant"""
    ...
    def __init__(self, db_config: Optional[Dict[str, Any]] = None, 
        ...
        # MCP Server
        self.mcp_server = Server("iacsgraph-query-assistant")
        ...
        self.handlers = MCPHandlers(
            query_assistant=self.query_assistant,
            mail_refresher=self.mail_refresher
        )
        ...
        logger.info(f"🚀 HTTP Streaming Query Assistant Server initialized on port {port}")
    ...
    async def _handle_streaming_request(self, request: Request):
        ...
        if method == 'initialize':
            ...
            self.sessions[session_id] = {
                ...
                'query_count': 0,  # Track query count for context
                'last_query_params': {}
            }
            ...
            response = {
                ...
                "result": {
                    ...
                    "serverInfo": {
                        ...
                        "version": "2.0.0",
                        "description": "Natural language query interface for IACSGRAPH database"
                    },
    ...
    def _create_app(self):
        ...
        async def health_check(request):
            ...
            return JSONResponse(
                {
                    "status": "healthy",
                    "server": "iacsgraph-query-assistant",
                    "version": "2.0.0",
    ...
    def run(self):
        ...
        logger.info(f"🚀 Starting HTTP Streaming Query Assistant Server on http://{self.host}:{self.port}")
