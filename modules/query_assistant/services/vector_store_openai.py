"""Vector store implementation using Qdrant with OpenAI embeddings"""
...
class VectorStoreOpenAI:
    """Qdrant-based vector store using OpenAI embeddings"""
    ...
    def __init__(
        ...
        """Initialize vector store with Qdrant client and OpenAI embeddings"""
    ...
    def index_templates(self, templates: List[QueryTemplate]) -> bool:
        ...
        try:
            ...
            logger.info(f"Indexed {len(templates)} templates successfully with OpenAI embeddings")
            return True
