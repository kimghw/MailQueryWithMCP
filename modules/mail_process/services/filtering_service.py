...
class FilteringService:
    ...
    def __init__(self):
        ...
        self.logger.info(f"메일 필터링 서비스 초기화 - 필터링 활성화: {self.filtering_enabled}")
        self.logger.debug(f"차단 도메인: {len(self.blocked_domains)}개, "
    ...
    def _should_process_mail(self, sender_address: str, subject: str = "") -> Tuple[bool, str]:
        """
        메일 처리 여부 결정
