    ...
    def validate_select_fields(cls, v):
        if v:
            allowed_fields = {
                ...
                'receivedDateTime', 'bodyPreview', 'body', 'isRead', 
...
class MailboxInfo(BaseModel):
    ...
    automatic_replies_setting: Optional[Dict[str, Any]] = Field(None, description="자동 회신 설정")
